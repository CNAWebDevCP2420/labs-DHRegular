...
<body>
  ...
  <?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (in_array($SongToAdd, $ExistingSongs)) {
            echo "<p>The song your entered already exists!<br />\n";
  ...
  <p>
      <a href="SongOragnizer.php?action=Sort%20Ascending">Sort Song List</a><br />
      <a href="SongOrganizer.php?action=Remove%20Duplicates">Remove Duplicates</a><br />
